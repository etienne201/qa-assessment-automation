...
- Name: negative/validation.spec.ts >> Negative — mandatory field validation >> TC_052 — phone with alphabetical characters is rejected
- Location: tests/negative/validation.spec.ts:78:7

# Error details

```
Error: No alert or DOM error found for field phone

expect(locator).toBeVisible() failed

Locator: locator('[id*="phone-error"], .error:near(:text("phone"))').first()
Expected: visible
Timeout: 5000ms
Error: element(s) not found

Call log:
  - No alert or DOM error found for field phone with timeout 5000ms
  - waiting for locator('[id*="phone-error"], .error:near(:text("phone"))').first()
...
- textbox "Phone Number (optional):": 123abc4567
